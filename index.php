...
<body>
            ...
            <div class="row gx-0">
                <div class="col-lg-6 wow zoomIn" data-wow-delay="0.1s">
                    <div class="shadow d-flex align-items-center justify-content-center p-4 bg-custom-dark"
                        ...
                        <div class="ps-4 ">
                            <h5 class="text-white mb-0">Our Clients</h5>
                ...
                <div class="col-lg-6 wow zoomIn" data-wow-delay="0.3s">
                    <div class="shadow d-flex align-items-center justify-content-center p-4 bg-primary-custom"
                        ...
                        <div class="ps-4">
                            <h5 class="text-custom-dark mb-0">Projects Completed</h5>
                ...
                <div class="col-lg-7">
                    ...
                    <div class="row g-0 mb-3">
                        <!-- <div class="col-sm-6 wow zoomIn" data-wow-delay="0.2s">
                            ...
                            <h5 class="mb-3"><i class="fa fa-check text-custom-dark me-3"></i>Professional Staff</h5>
                        </div>
                        <div class="col-sm-6 wow zoomIn" data-wow-delay="0.4s">
                            <h5 class="mb-3"><i class="fa fa-check text-custom-dark me-3"></i>24/7 Support</h5>
                            <h5 class="mb-3"><i class="fa fa-check text-custom-dark me-3"></i>Fair Prices</h5>
                        </div> -->
                    </div>
    ...
    <div class="container-fluid py-5 wow fadeInUp" data-wow-delay="0.1s">
        <div class="container py-5">
            <div class="section-title text-center position-relative pb-3 mb-5 mx-auto" style="max-width: 600px;">
                <h5 class="fw-bold text-custom-dark text-uppercase"> Why Choose Us for Exponential Growth</h5>
                <h1 class="mb-0">Elevate Your Business</h1>
            </div>
            <div class="row g-5">
                <div class="col-lg-4">
                    <div class="row g-5">
                ...
                <div class="col-lg-4">
                    <div class="row g-5">
                        ...
                        <div class="col-12 wow zoomIn" data-wow-delay="0.8s">
                            ...
                            <p class="mb-0">Scalable and adaptable solutions for seamless business growth and evolution.
    ...
    <div class="container-fluid py-5 wow fadeInUp" data-wow-delay="0.1s">
        <div class="container py-5">
            <div class="section-title text-center position-relative pb-3 mb-4 mx-auto" style="max-width: 600px;">
                <h5 class="fw-bold text-custom-dark text-uppercase">Featured Clients</h5>
                <h1 class="mb-0">Hear from Our Clients and Their Success Stories</h1>
            </div>
    ...
    <!-- <div class="container-fluid py-5 wow fadeInUp" data-wow-delay="0.1s">
        <div class="container py-5">
            <div class="section-title text-center position-relative pb-3 mb-5 mx-auto" style="max-width: 600px;">
                <h5 class="fw-bold text-custom-dark text-uppercase">Team Members</h5>
                ...
                <div class="col-lg-4 wow slideInUp" data-wow-delay="0.3s">
                    <div class="team-item bg-light rounded overflow-hidden">
                        ...
                        <div class="text-center py-4">
                            <h4 class="text-custom-dark">Full Name</h4>
    ...
    <div class="container-fluid py-5 wow fadeInUp" data-wow-delay="0.1s">
        <div class="container py-5">
            <div class="row g-5">
                <div class="col-lg-7">
                    <div class="section-title position-relative pb-3 mb-5">
                        <h5 class="fw-bold text-custom-dark text-uppercase">Request A Quote</h5>
                        <h1 class="mb-0">Contact Us for Your Custom Solution</h1>
                    </div>
                    <div class="row gx-3">
                        <div class="col-sm-6 wow zoomIn" data-wow-delay="0.2s">
                    ...
                    <div class=" d-flex align-items-center mt-2 wow zoomIn row" data-wow-delay="0.6s">
                        ...
                        <div class="ps-4 col-lg-4">
                            <h5 class="mb-2">WhatsApp us any time </h5>
    ...
    <!-- <div class="container-fluid py-5 wow fadeInUp" data-wow-delay="0.1s">
        <div class="container py-5">
            <div class="section-title text-center position-relative pb-3 mb-5 mx-auto" style="max-width: 600px;">
                <h5 class="fw-bold text-custom-dark text-uppercase">Latest Blog</h5>
                ...
                <div class="col-lg-4 wow slideInUp" data-wow-delay="0.3s">
                    <div class="blog-item bg-light rounded overflow-hidden">
                        <div class="blog-img position-relative overflow-hidden">
                            ...
                            <a class="position-absolute top-0 start-0 bg-custom-dark text-white rounded-end mt-5 py-2 px-4" href="">Web Design</a>
                        </div>
                        <div class="p-4">
                            <div class="d-flex mb-3">
                                <small class="me-3"><i class="far fa-user text-custom-dark me-2"></i>John Doe</small>
                                <small><i class="far fa-calendar text-custom-dark me-2"></i>01 Jan, 2045</small>
                            </div>
                            <h4 class="mb-3">How to build a website</h4>
                            <p>Dolor et eos labore stet justo sed est sed sed sed dolor stet amet</p>
                            <a class="text-uppercase text-custom-dark" href="">Read More <i class="bi bi-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 wow slideInUp" data-wow-delay="0.6s">
                ...
                <div class="col-lg-8 col-md-6">
                    <div class="row gx-5">
                        <div class="col-lg-4 col-md-12 pt-5 mb-5">
                            ...
                            <div class="d-flex mb-2">
                                <i class="bi bi-whatsapp text-custom-dark me-2"></i>
